...
$result=mysqli_query($con,"SELECT * FROM poll WHERE member_id = '$_SESSION[member_id]'")
...
/*        $sql = mysql_query( "UPDATE tbMembers SET first_name='$myFirstName', last_name='$myLastName', email='$myEmail', voter_id = '$myVoterid', password='$newpass' WHERE member_id = '$myId'" )
  ...
  $sql = mysqli_query( $con,"UPDATE tbMembers SET firstname='$myFirstName', lastname='$myLastName', email='$myEmail', voter_id = '$myVoterid', password='$myPassword' WHERE member_id = '$myId'" )
          or die( mysqli_error() );
